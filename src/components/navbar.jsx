    ...
    <>
      <div className="flex  justify-between max-w-[1920px] w-full absolute top-0 items-center z-20">
        <div className="w-[80px] h-[80px] sm:w-[123px] sm:h-[129px] sm:pl-[49px] pt-5 ">
          <img src={leftlogo} alt=" logo " className="h-full w-full hidden sm:block"/>
          <img src={leftlogo} alt=" logo " className="w-[80px] h-[80px] sm:hidden "/>
        </div>
        <div className="hidden xl:block xl:flex justify-end w-full max-w-[1001px] pt-[39px] mr-1 ">
          ...
          <div className=" flex items-center pr-5 xl:hidden  "  onClick={toggleMenu}>
             {
              isOpen ? <RxCross2 size={30} className="text-red cursor-pointer"/>:<GiHamburgerMenu size={30} className="text-blue-400 cursor-pointer "/>
             }
              </div>
              {
                isOpen && 
